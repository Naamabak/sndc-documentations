...
function getMarkdownTitle(directory, filename) {
    var text = fs.readFileSync('./_vuepress_snds/' + directory + '/' + filename);
...
function listMarkdownFilesInDirectory(directoryName) {
    return fs
        ...
        .readdirSync('./_vuepress_snds/' + directoryName)
...
function listSubDirectories(directoryName) {
    return fs
        ...
        .filter(function (filename) {
            return fs.lstatSync('./_vuepress_snds/' + directoryName + '/' + filename).isDirectory();
        })
...
const getSidebarGroup = function (directoryPath) {
    ...
    if (fs.existsSync('./_vuepress_snds/' + directoryPath + '/README.md')) {
