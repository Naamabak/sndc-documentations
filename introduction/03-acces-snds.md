...
Ces documents doivent être présentés conformément à des modèles établis par arrêté des ministres chargés de la santé et de la sécurité sociale, publiés au JO le 15 avril 2017 ([Télécharger]() le modèle « caractéristique des traitements » et [Télécharger]() le modèle « personnes habilitées »).
:::
