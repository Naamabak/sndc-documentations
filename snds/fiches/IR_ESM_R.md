...
## Références
::: tip Ressources
Ce document a été rédigé par la Cnam et a été converti en Markdown pour être publié ici, et servir plus facilement de ressources pour d'autres fiches. Il est [téléchargeable ici](https://documentation-snds.health-data-hub.fr/files/Cnam/20210429_Cnam_IR_ESM_R_sansprofils_MPL-2.0.docx) dans sa version d'origine.
