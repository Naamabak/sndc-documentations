...
<br />
<div>
    <a href="https://gitlab.com/healthdatahub/schema-snds/edit/master/schemas/PMSI%20HAD/T_HADaaSTC.json"  
...
`TOT_MNT_AM_CTL`|chaîne de caractères|Contrôle format montant total remboursable par AM||
...
`MAJ_MNT_PS`|nombre entier|Montant lié à la majoration au parcours de soin||
...
`RNG_BEN`|nombre entier|Rang du bénéficiaire ||
`RNG_BEN_CTL`|nombre entier|Code retour contrôle « Rang du bénéficiaire »||
`RNG_NAI`|nombre entier|Rang de naissance ||
`RNG_NAI_CTL`|nombre entier|Code retour contrôle « Rang de naissance »||
