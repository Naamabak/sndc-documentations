...
<br />
<div>
    <a href="https://gitlab.com/healthdatahub/schema-snds/edit/master/schemas/PMSI%20HAD/T_HADaaB.json"  
...
`ETA_GRP_GHPC`|nombre entier|Groupage établissement : n° du GHPC||
`ETA_GRP_RET`|nombre entier|Groupage établissement : code retour||
`ETA_GRP_VER`|nombre entier|Groupage établissement : version de la classification||
...
`RPSS_VER`|nombre entier|N° de version du format du RPSS||
