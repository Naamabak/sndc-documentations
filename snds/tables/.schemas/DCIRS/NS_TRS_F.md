...
<br />
<div>
    <a href="https://gitlab.com/healthdatahub/schema-snds/edit/master/schemas/DCIRS/NS_TRS_F.json"  
...
`TRS_DTD_AME`|chaîne de caractères|Date de départ (année et mois) du transport||
...
`TRS_DTF_AME`|chaîne de caractères|Date d&#x27;arrivée (année et mois) du transport||
