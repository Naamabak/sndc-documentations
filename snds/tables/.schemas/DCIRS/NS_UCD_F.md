...
`UCD_ECT_MNT`|nombre entier|Montant UCD total de l&#x27;écart indemnisable||
`UCD_ECU_MNT`|nombre entier|Montant UCD unitaire de l&#x27;écart indemnisable||
`UCD_FAC_PRU`|nombre entier|Prix unitaire facturé||
`UCD_FRC_COE`|nombre entier|Coefficient de fractionnement||
`UCD_MAR_MNT`|nombre entier|Montant UCD TTC de la marge de rétrocession||
`UCD_RCT_COU`|nombre entier|Coût de reconstitution du médicament||
