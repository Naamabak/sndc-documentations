...
`TIP_PRS_IDE`|nombre entier|Code LPP du produit ou de la prestation||
`LPP_ECT_MNT`|nombre entier|Montant total de l&#x27;écart indemnisable LPP||
`LPP_ECU_MNT`|nombre entier|Montant unitaire de l&#x27;écart indemnisable LPP||
`TIP_ACL_DTD`|date|Date de début de location ou d&#x27;achat||
`TIP_ACL_DTF`|date|Date de fin de location ou d&#x27;achat||
`TIP_ACT_PRU`|nombre entier|Prix unitaire LPP du produit ou de la prestation||
`TIP_PRS_TYP`|nombre entier|Type de prestation fournie||
`TIP_PUB_PRX`|nombre entier|Prix unitaire public||
