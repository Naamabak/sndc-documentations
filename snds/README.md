...
## Contribuer
Le [guide de contribution](contribuer/README.md) reprend les différents modes de contribution à la documentation. Des documents peuvent également être envoyés par mail à l'adresse _opensource@health-data-hub.fr_ ou déposés dans la [boite aux lettres](https://gitlab.com/healthdatahub/documentation-snds/-/tree/master/Boite_aux_lettres), ces derniers seront intégrés à la documentation par le Health Data Hub.
